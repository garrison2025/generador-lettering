...
import { AlignLeft, AlignCenter, AlignRight, RotateCcw, Loader2, Download } from "lucide-react" // RotateCcw 会用到
...
// import { MobileEditorControls } from "@/components/mobile-editor-controls" // 稍后
...
export default function EditorClient() {
  ...
  const textStyle: React.CSSProperties = {
    ...
    lineHeight: lineHeight, transform: `rotate(${rotation}deg)`, // 使用 rotation state
  ...
  console.log("STAGE 2d: Populating FULL Estilo Tab.");
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <p style={{color: 'green', marginTop: '20px', textAlign: 'center', fontWeight: 'bold'}}>STAGE 2d TEST: Populated FULL "Estilo" Tab (Color, Spacing, LineHeight, Rotation).</p>
      </main>
      <SiteFooter />
    </div>
  )
